...
function Lecturer() {
  ...
  const imgUrl = "https://images.unsplash.com/photo-1697059361419-349e924ed363?q=80&w=1330&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  return (
